...
// Sample data
const data = [
    { id: 1, image: 'css/images/image_1.jpg', filename: 'file1', prompt: 'test1', user: 'owen', timestamp: '2023-07-19', quality: 'hd', style: 'natural', model: 'dall-e-3', size: '1024x1024' },
    { id: 2, image: 'css/images/image_2.jpg', filename: 'file2', prompt: 'test2', user: 'zane', timestamp: '2023-07-20', quality: 'hd', style: 'natural', model: 'dall-e-3', size: '1024x1024' },
    { id: 3, image: 'css/images/image_3.jpg', filename: 'file3', prompt: 'test3', user: 'brayden', timestamp: '2023-07-21', quality: 'hd', style: 'natural', model: 'dall-e-3', size: '1024x1024' },
    { id: 4, image: 'css/images/image_4.jpg', filename: 'file4', prompt: 'Cat on the moon jumping over a spaceship', user: 'zane', timestamp: '2023-07-22', quality: 'hd', style: 'natural', model: 'dall-e-3', size: '1024x1024' },
    { id: 5, image: 'css/images/image_5.jpg', filename: 'file5', prompt: 'Design an isolated [image style] graphic featuring [subject] against a solid white background. Make sure the [subject] has [elements, attributes]. Include themes of [colors, themes]. Incorporate stylized verbiage surrounding the subject that says, [verbiage]. Stylize the subject accordingly, ensure correct spelling, and make sure nothing is cut off at the edges of the image.', user: 'owen', timestamp: '2023-07-23', quality: 'hd', style: 'natural', model: 'dall-e-3', size: '1024x1024' },
...
function renderTable(data) {
    ...
    data.forEach(item => {
        ...
        row.innerHTML = `
          <td>${item.id}</td>
          <td><img src="${item.image}" alt="${item.filename}" width="50" class="clickable-image"></td>
          <td>${item.filename}</td>
